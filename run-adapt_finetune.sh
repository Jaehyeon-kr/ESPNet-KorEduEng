...
pretrained_model="exp_ex4_finetun/asr_train_asr_conformer_raw_en_bpe5000_sp/valid.acc.ave_10best.pth"
skip_stages="1 "
...
./asr.sh \
    ...
    --lm_config "${lm_config}" \
    --speed_perturb_factors "0.8 0.9 0.95 1.0 1.05 1.1 1.2" \
